<template>
  <v-client-table name="test" :data="tableData" :columns="columns" :options="options"></v-client-table>
</template>
...
<script>
  ...
  Vue.use(VueTables.client, {
    ...
    skin: 'table-striped table-inverse table-hover',
    childRow: function (h, row) {
      return <div>My custom content for row {row.id}</div>
      //return h('div', 'My custom content for row {row.id}');
    },
  }, true);
